...
class RhythmMasterGame:
    ...
    def __init__(self, drums):
        ...
        self.judge_line_y = 0.80  # 判定线位置（归一化，稍微上移避免与底部UI挤在一起）
        ...
        # 轨道颜色（BGR，来源 RGB: 蓝/黄系自定义）
        self.lane_colors = [
            (215, 235, 250),  # RGB(250,235,215) -> BGR
            (194, 194, 244)   # RGB(244,194,194) -> BGR
        ]
        self.lane_outline_colors = [
            (153, 136, 204),  # RGB(204,136,153) -> BGR
            (80, 94, 85)      # RGB(85,94,80) -> BGR
        ]
